"""
Django settings for Ticketi project.
...
SECRET_KEY = '+^*0ws7@w(blb_w%9vyw=bby9npvz=!yq6x7le(im_#9(^1^q8'
...
WSGI_APPLICATION = 'Ticketi.wsgi.application'
